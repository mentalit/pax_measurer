...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference("Measurement.count") do
      post measurements_url, params: { measurement: { depth: @measurement.depth, length: @measurement.length, room_id: @measurement.room_id, width: @measurement.width } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { depth: @measurement.depth, length: @measurement.length, room_id: @measurement.room_id, width: @measurement.width } }
